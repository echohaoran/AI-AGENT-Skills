...
> Curated AI Agent Skills Collection | Supports Alma Desktop AI
...
| [file-organizer](sources/file-organizer/SKILL.md) | 📁 Smart file organization |
| [git-workflow](sources/git-workflow/SKILL.md) | 🔀 Git workflow, branching strategy |
| [code-review-quality](sources/code-review-quality/SKILL.md) | ✅ Automated code review |
| [mysql](sources/mysql/SKILL.md) | 🗄️ MySQL database queries |
...
| Feishu & Miaoda Package | 27 |
| Alma Built-in Package | 30 |
| **Total** | **~82** |
...
├── wps/                    # WPS Office
├── Nano_Pdf/              # PDF editing
├── self_improving_agent/  # Self-improving
├── Find_Skills_Skill/     # Skill discovery
├── Agent_Browser/         # Browser automation
├── Skill_Vetter/          # Security vetting
├── feishu/                # Feishu basic
...
├── marp/                  # External repo
├── mermaid/               # External repo
├── pdf-generator/         # External repo
└── document-xlsx/         # External repo
```
...
- **Gitee Repo**: https://gitee.com/echohaoran/ai-agent-skills
- **Alma Website**: https://almachat.com
...
| 2026-04-17 | Added alma-bundled Skills Package (30) |
